...
Once we have a process, we can create live collections on that process (see [Live Collections](../introduction/live-collections.md) for more details). For example, we can create a stream of integers on the leader process:
